...
from few_shot_detection.fsdet.evaluation.evaluator import DatasetEvaluator
from few_shot_detection.fsdet.utils.file_io import PathManager
...
class ScalabelEvaluator(DatasetEvaluator):
        ...
        for input, output in zip(inputs, outputs):
            ...
            if "instances" in output:
                ...
                for box, score, pred_class in zip(
                    [box for box in instances.get("pred_boxes")],
    ...
    def save_predictions(self):  # save predictions
        with open(
            PathManager.get_local_path(self._output_dir + "/predictions.json"),
            "w",
        ) as f:
